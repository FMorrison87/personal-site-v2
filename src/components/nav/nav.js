  ...
  return (
    <nav style={navWrapper}>
      <div className="nav_link-wrapper" data-active={menuActive}>
        ...
        <Link href="mailto:Frances.Morrison87@gmail.com.com" underline="none">
          Contact Me
        </Link>
        <div className="nav_icon-link-wrapper">
          <Link
            href="https://github.com/FMorrison87"
            target="_blank"
            rel="noopener"
            underline="none"
          >
          ...
          <Link
            href="https://www.linkedin.com/in/frances-morrison87/"
            target="_blank"
            rel="noopener"
            underline="none"
          >
      ...
      <div className="nav_hamburger-wrapper" onClick={toggleMenu} ref={ref}>
        {menuActive ? (
          <MenuOpenIcon className="nav_menu-icon" />
        ) : (
          <MenuIcon className="nav_menu-icon" />
        )}
      </div>
    </nav>
  );
